...
import { AntDesign,FontAwesome,Ionicons,FontAwesome5,EvilIcons,MaterialIcons,MaterialCommunityIcons,Foundation   } from '@expo/vector-icons';
  ...
  return (
    <View style={{flex:1,marginTop:40}}>
        <View style={{height:900}}>
            ...
            <Image source={require('../assets/logo.jpg')} style={{height:80,width:80}}/>
            ...
            <View style={{marginTop:15}}>
                <Text style={{marginLeft:20,fontSize:20,fontWeight:'bold'}}>Top Categories</Text>
            </View>
